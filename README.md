...
-   [unitree_h1_control_ws](https://github.com/cyberbanana777/unitree_h1_control_ws) - Репозиторий, в котором содержится библиотека, содержащая наиболее часто используемые функции, словари и тд при работе с Unitree H1 и библиотека, содержащая необходимые типы сообщений для Unitree H1. Инструкция по установке находится внутри репозитория и также есть bash-скрипт, котоый полоностью устанавливает репозиторий и все зависммости и библиотеки. Находится он [здесь](https://github.com/cyberbanana777/unitree_h1_meta_launch_ws?tab=readme-ov-file#соло-скрипты). Подробнее читайте в инструкции к репозиториям.
